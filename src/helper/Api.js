...
const getallmenucategories = async () => {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/get_all_menu_categories`);
    const result = await response.json();
    return result;
  } catch (error) {
    console.log('Error fetching Data', error);
...
const getallproducts = async (rbody) => {
  try {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/get_allproducts`, config);
    const result = await response.json();
    return result;
  } catch (error) {
    console.log('Error fetching Data', error);
...
const sendemail = async (rbody) => {
  try {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/send_email`, config);
    const result = await response.json();
    return result;
  } catch (error) {
