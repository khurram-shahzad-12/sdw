...
const OurJourney = ({ suppliers }) => {
    return (
        <section className="sm:w-11/12 md:w-5/6 mx-auto md:mt-8 sm:mt-4">
            ...
            <section className='sm:my-6 md:my-8 rounded-sm'>
                <div>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/-vbIi1ZJhJI" title="Welcome to Spice Direct Wholesale - An Introduction to Our Wholesale Business" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen className='sm: h-60 md:h-[550px] sm:rounded-sm'></iframe>
                </div>
            </section>
            <OurProcess/>
            ...
            <section className='mt-14 mb-20'>
                ...
                <div className='w-full md:my-12 sm:my-8'>
                    <Marquee>
